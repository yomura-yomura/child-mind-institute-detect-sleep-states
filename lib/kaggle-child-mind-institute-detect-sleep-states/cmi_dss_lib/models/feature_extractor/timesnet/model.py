...
class TimesNet(nn.Module):
    ...
    def __init__(
        ...
        self.model = nn.ModuleList([TimesBlock(len_input, top_k, d_model, d_ff, num_kernels) for _ in range(e_layers)])
        self.enc_embedding = DataEmbedding(enc_in, d_model, len_input, embed, freq, dropout)
        self.layer = e_layers
