...
class Plotter:
    ...
    def plot(self, i: int, do_plot: bool = True):
        ...
        if "wakeup" in self.events:
            wakeup_label_steps = label_df[(label_df["wakeup"] == 1).astype(bool)]["step"].to_numpy()
...
if __name__ == "__main__":
    ...
    plotters = [Plotter(exp_name, i_fold=i_fold, dataset_type="valid") for i_fold in tqdm.trange(5)]
